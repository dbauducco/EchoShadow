...
// https://github.com/nut-tree/nut.js/blob/develop/lib/provider/native/libnut-keyboard-action.class.ts
  ...
  private static key(
    ...
    return new Promise<void>((resolve, reject) => {
      try {
        ...
        if (nativeKey) {
          keyToggle(nativeKey, event, modifierKeys);
        }
        resolve();
      } catch (e) {
        reject(e);
